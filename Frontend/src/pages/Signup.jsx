...
const Signup = () => {
  ...
  max-w-[95%] sm:max-w-md lg:max-w-lg
  px-5 sm:px-8 
  py-6 sm:py-8 
  rounded-2xl 
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <User className="absolute left-3 top-4.5 w-4 h-4 text-gray-500" />
              <input
                type="text"
                value={form.name}
                onChange={(e) => setForm({ ...form, name: e.target.value })}
                placeholder="John Doe"
                className="w-full pl-10 py-2.5 sm:py-2.5 rounded-xl bg-white/5 border border-white/10 focus:outline-none focus:border-purple-500 text-white placeholder-gray-500 text-sm sm:text-base"
                required
              />
            </div>
            {errors.name && (
          ...
          <div>
            ...
            text-white placeholder-gray-500 text-sm sm:text-base"
              ...
              <button
                ...
                className="absolute right-3 top-4.5 text-gray-400"
              >
